...
async function main() {
    ...
    try {
        ...
        const stationsResponse = await huaweiService_1.huaweiService.getStationList();
        ...
        for (const station of stations) {
            ...
            const site = await prisma_1.default.site.upsert({
            ...
            const devResponse = await huaweiService_1.huaweiService.getDevList(site.plantCode);
